            ...
            result.propertyList.map(itemObj => {
                if (itemObj) {
                    propertyList.push({
                        ...
                        itemTypeId: !itemObj.contract.templateMetadata ? (findNestedObj(itemObj.contract.templateMetadata, 'name', 'itemTypeId') ? findNestedObj(itemObj.contract.templateMetadata, 'name', 'itemTypeId').value : 'None') : '',
